...
<head>
    ...
    <title>View Issued Books | LMS</title>
...
<body>
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <button class="bookbtn btn btn-info"><a href="returnbooks.php?bid=<?php echo $row['book_id']; ?>">Return</a></button>
                                </td>
                            </tr>
                        <?php
                        }
    ...
    <script>
        function sortBooks(sortBy) {
            ...
            window.location.href = `viewissuedbook.php?sort_by=${sortBy}`;
        }
    </script>
</body>
