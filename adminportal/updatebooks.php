...
<body>
                ...
                <div class="col-md-12">
                    <table class="table table-bordered table-striped">
                        ...
                        ?>
                            ...
                            <tr>
                                <td><img src="<?php echo $row['book_image']; ?>" alt="Book Image" style="margin-left:20px; width:110px; height:130px;"></td>
                                ...
                                <td>
                                    <button class="bookbtn btn btn-danger"><a href="editbook.php?bid=<?php echo $row['book_id']; ?>">Edit</a></button>
                                    <button class="bookbtn btn btn-primary"><a href="deletebook.php?bid=<?php echo $row['book_id']; ?>">Delete</a></button>
                                    <button class="bookbtn btn btn-success"><a href="issuebook.php?bid=<?php echo $row['book_id']; ?>">Issue</a></button>
                                </td>
                            </tr>
                        <?php
                        }
                    ...
                    <div class="alert alert-danger " id="error-message" style="display: none; text-align:center; margin-top:20px;">
                        <strong>Book has been issued!</strong> Cannot delete it.
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        function sortBooks(sortBy) {
            ...
            window.location.href = `updatebooks.php?sort_by=${sortBy}`;
        }
    </script>
</body>
