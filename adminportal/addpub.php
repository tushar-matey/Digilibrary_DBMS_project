            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <form action="" method="post">
                        ...
                        <button type="submit" name="add_pub" class="btn btn-primary">Add Publisher</button>
                    </form>
                </div>
                <div class="col-md-4"></div>
...
if(isset($_POST['add_pub'])) {
    ...
    $check_query = "SELECT * FROM publishers WHERE pub_name = '$pub_name'";
    ...
    if(mysqli_num_rows($check_result) > 0) {
        ...
        $query = "INSERT INTO publishers (pub_name) VALUES ('$pub_name')";
        $query_run = mysqli_query($connection, $query);
        if($query_run) {
