...
<body>
    ...
    <section class="home-section">
        ...
        <div class="box">
            <center>
                <h4>Student Profile Details Update</h4><br>
            </center>
                ...
                <div class="col-md-5">
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="<?php echo $rollno ?>" disabled>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="email" class="form-control" value="<?php echo $email; ?>" pattern="^[A-Za-z]+\s*\d{2}@pdpu\.com$">
                        </div>
                        <div class="form-group">
...
if (isset($_POST['update'])) {
    ...
    $query = "SELECT rollno FROM users WHERE email = '{$student_email}' LIMIT 1";
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        $update_query = "UPDATE users SET firstname = '{$_POST['firstname']}', lastname = '{$_POST['lastname']}', email = '{$_POST['email']}', password = '{$hashed_password}', mobile = '{$_POST['mobile']}'";
        ...
        $update_query .= " WHERE rollno = '{$student_id}'";
