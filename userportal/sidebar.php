...
<div class="sidebar">
    <div class="nav-logo">
        <span style="color: white; font-size: 25px;"><a class="logo" href="userdashboard.php
    ...
    <ul class="nav-links">
        ...
        <li>
            <a href="viewissuedbooks.php">
                <i class='bx bx-line-chart'></i>
                <span class="link_name">View Issued Book</span>
            </a>
        </li>
        <li>
            <a href="searchbooks.php">
                <i class='bx bx-line-chart'></i>
                <span class="link_name">Search books</span>
            </a>
        </li>
        <li>
            <a href="requestbook.php">
                <i class='bx bx-compass'></i>
                <span class="link_name">Request Books</span>
            </a>
        </li>
        <li>
        ...
        <li>
            <div class="profile-details">
                ...
                <div class="name-job">
                    ...
                    <div class="job">Welcome! Student</div>
                </div>
